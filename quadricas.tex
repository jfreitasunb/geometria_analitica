...
\[
	...
	\end{bmatrix}.
\]
Da{\'\i} $\vec{U_1}$, $\vec{U_2}$ e $\vec{U_3}$ devem satisfazer as equações
\[
...
Portanto a mudança que elemina os termos $xy$, $xz$ e $yz$ \'e dada por $Q = [\vec{U_1}\ \vec{U_2}\ \vec{U_3}]$. Assim temos o seguinte teorema:
