...
Seja $k \ne 0$. A interseção do cone elíptico de equação \eqref{cone_eliptico} com o plano $z = k$ é a elipse de equação
\[
	\dfrac{x^2}{a^2k^2} + \dfrac{y^2}{b^2k^2} = 1.
\]
Já sua interseção com o plano $y = k$ é a hipérbole de equação
\[
	\dfrac{z^2}{k^2/b^2} - \dfrac{x^2}{a^2k^2/b^2} = 1
\]
e com o plano $x = k$ é a hipérbole de equação
\[
