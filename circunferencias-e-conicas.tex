...
\begin{corolario}
  ...
  \begin{enumerate}
    \item Se $p > 0$ e $q < 0$, ent\~ao $a^2 = p$ e $b^2 = -q$, $\mathcal{H}$ tem centro na origem, focos no eixo $x$ e assíntotas dadas por $y = \pm(b/a)x$.
    \item Se $p < 0$ e $q > 0$, ent\~ao $a^2 = q$ e $b^2 = -p$, $\mathcal{H}$ tem centro na origem, focos no eixo $y$ e assíntotas dadas por $x = \pm(a/b)y$.
  \end{enumerate}
\end{corolario}
