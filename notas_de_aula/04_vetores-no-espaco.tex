...
\chapter{Vetores no Espaço} % (fold)
...
\subsection{Ângulo entre vetores e produto interno no espaço} % (fold)
...
\end{proposicao}
\begin{prova}
  Análoga \`a prova da Proposição \ref{DesigualdadeTriangular}.
\end{prova}
