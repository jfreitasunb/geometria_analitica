...
\chapter{Reta e Plano no Espaço} % (fold)
\label{cha:reta_e_plano_no_espaco}

\section{Equações do Plano} % (fold)
...
% O plano $\pi$ definido por $s$ e $s'$ é paralelo a $r$, daí a distância de $r$ a $\pi$ é constante. Esta constante é \textbf{a menor distância} entre $r$ e $s$. De fato, seja $r'$ uma reta contida em $\pi$ e paralela a $r$. Seja $I$ um ponto de $r$. Por $I$ tracemos um perpendicular a $r$ que a intercepta em um ponto $Q$. Se $P$ é um ponto qualquer de $s$ temos
% \[
...
% \]
% Mas $\overline{IQ}$ é a distância de $\pi$ a $r$, logo segue da \'ultima desigualdade que a distância de $\pi$ a $r$ é menor ou igual a distância entre um ponto de $r$ e um ponto de $s$. Portanto
% \[
%     d(r,s) = d(r,\pi).
% \]
