        ...
        \item O vetor normal é $\vec{v} = (0,0,1)$ e $P_0(0,0,0)$.
              \begin{solucao}
                  ...
                  \begin{figure}[H]
                      \centering
                      \caption{Plano $y = 0$}
                      \includegraphics[scale=0.4]{plano-y=0.png}
                  ...
                  \begin{figure}[H]
                      \centering
                      \caption{Plano $x = 0$}
                      \includegraphics[scale=0.4]{plano-x=0.png}
...
\begin{figure}[h]
    ...
    \includegraphics[scale=0.4]{intersecao-tres-planos.png}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[scale=0.2]{posicao_planos_tres_planos_dois_a_dois_retas.png}
    % \definecolor{zzttqq}{rgb}{0.6,0.2,0}
    % \begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
...
\begin{figure}[h]
    \centering
    \caption{$r \subset \pi$}
    \includegraphics[scale=0.3]{reta-contida-no-plano.png}
    % \definecolor{zzttqq}{rgb}{0.6,0.2,0}
    % \begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
...
\begin{figure}[!h]
    ...
    \includegraphics[scale=0.3]{distancia-ponto-plano.png}
\end{figure}
...
\begin{figure}[!h]
    \centering
    \caption{Distância entre ponto e plano}
    \includegraphics[scale=0.3]{distancia-ponto-plano-vetores.png}
\end{figure}
