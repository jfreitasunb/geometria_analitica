...
\todo{Melhor figura de três planos paralelos}
\begin{figure}
    \centering
    \caption{$\pi_1\cap\pi_2\cap\pi_3 = \emptyset$}
    \definecolor{zzttqq}{rgb}{0.6,0.2,0}
